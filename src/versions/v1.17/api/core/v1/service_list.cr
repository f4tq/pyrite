...
module Pyrite
  ...
  class Api::Core::V1::ServiceList
    getter api_version : String = "v1"
    getter kind : String = "List"
    # List of services
    property items : Array(Api::Core::V1::Service)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Core::V1::Service), nilable: false, key: "items", getter: false, setter: false},
