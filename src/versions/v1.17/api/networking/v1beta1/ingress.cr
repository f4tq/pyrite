...
module Pyrite
  ...
  class Api::Networking::V1beta1::Ingress
    ...
    ::YAML.mapping({
      api_version: {type: String, default: "networking/v1beta1", key: "apiVersion", setter: false},
      kind:        {type: String, default: "Ingress", key: "kind", setter: false},
      metadata:    {type: Apimachinery::Apis::Meta::V1::ObjectMeta, nilable: true, key: "metadata", getter: false, setter: false},
      spec:        {type: Api::Networking::V1beta1::IngressSpec, nilable: true, key: "spec", getter: false, setter: false},
      status:      {type: Api::Networking::V1beta1::IngressStatus, nilable: true, key: "status", getter: false, setter: false},
    }, true)
