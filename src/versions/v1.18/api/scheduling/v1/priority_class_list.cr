...
module Pyrite
  ...
  class Api::Scheduling::V1::PriorityClassList
    getter api_version : String = "v1"
    getter kind : String = "List"
    # items is the list of PriorityClasses
    property items : Array(Api::Scheduling::V1::PriorityClass)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Scheduling::V1::PriorityClass), nilable: false, key: "items", getter: false, setter: false},
