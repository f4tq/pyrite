...
module Pyrite
  ...
  class Api::Storage::V1alpha1::VolumeAttachmentList
    getter api_version : String = "v1"
    getter kind : String = "List"
    # Items is the list of VolumeAttachments
    property items : Array(Api::Storage::V1alpha1::VolumeAttachment)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Storage::V1alpha1::VolumeAttachment), nilable: false, key: "items", getter: false, setter: false},
