...
module Pyrite
  ...
  class Api::Rbac::V1beta1::RoleList
    getter api_version : String = "v1"
    getter kind : String = "List"
    # Items is a list of Roles
    property items : Array(Api::Rbac::V1beta1::Role)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Rbac::V1beta1::Role), nilable: false, key: "items", getter: false, setter: false},
