...
module Pyrite
  ...
  class Api::Core::V1::EndpointsList
    getter api_version : String = "v1"
    getter kind : String = "List"
    # List of endpoints.
    property items : Array(Api::Core::V1::Endpoints)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Core::V1::Endpoints), nilable: false, key: "items", getter: false, setter: false},
